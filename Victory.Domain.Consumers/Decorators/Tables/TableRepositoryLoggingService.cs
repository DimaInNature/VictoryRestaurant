namespace Victory.Domain.Consumers.Decorators.Tables;

public class TableRepositoryLoggingService : ITableRepositoryService
{
    private readonly ITableRepositoryService _repository;

    private readonly ILogger<TableRepositoryLoggingService> _logger;

    public TableRepositoryLoggingService(
        ITableRepositoryService repository,
        ILogger<TableRepositoryLoggingService> logger) =>

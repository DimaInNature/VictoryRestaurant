namespace Victory.Application.CQRS.Clients.Integrations.CloudinaryImages;
...
public class UploadImageCommandHandler : IRequestHandler<UploadImageCommand, string?>
{
    ...
    {
        if (request.Image?.ImagePath is null | request.Account is null | request.SubFolder is null | request.Name is null)
            return null;

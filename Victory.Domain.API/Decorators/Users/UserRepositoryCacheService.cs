namespace Victory.Domain.API.Decorators.Users;
...
public class UserRepositoryCacheService : IUserRepositoryService
{
    ...
    private readonly IAsyncCacheService<UserEntity> _cache;

    public UserRepositoryCacheService(IAsyncCacheService<UserEntity> cache,

namespace Victory.Domain.API.Decorators.FoodTypes;

public class FoodTypeRepositoryCacheService : IFoodTypeRepositoryService
{
    private const string NameForCaching = "FoodType";

    private readonly IFoodTypeRepositoryService _repository;

    private readonly IAsyncCacheService<FoodTypeEntity> _cache;

    public FoodTypeRepositoryCacheService(IFoodTypeRepositoryService repository,
        IAsyncCacheService<FoodTypeEntity> cache) =>

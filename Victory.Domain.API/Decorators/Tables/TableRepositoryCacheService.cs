namespace Victory.Domain.API.Decorators.Tables;

public class TableRepositoryCacheService : ITableRepositoryService
{
    private const string NameForCaching = "Table";

    private readonly ITableRepositoryService _repository;

    private readonly IAsyncCacheService<TableEntity> _cache;

    public TableRepositoryCacheService(ITableRepositoryService repository,
        IAsyncCacheService<TableEntity> cache) =>
